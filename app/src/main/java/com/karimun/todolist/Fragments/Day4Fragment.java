...
import com.karimun.todolist.Adapters.TodoListDay4Adapter;
...
import com.karimun.todolist.databinding.FragmentDay4Binding;
...
public class Day4Fragment extends Fragment {
    //private static final String TAG = Day4Fragment.class.getSimpleName();

    FragmentDay4Binding binding;
    TodoListDay4Adapter todoListDay4Adapter;
    TaskViewModel taskViewModel;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentDay4Binding.inflate(inflater);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        todoListDay4Adapter = new TodoListDay4Adapter();
        taskViewModel = ViewModelProviders.of(this).get(TaskViewModel.class);

        binding.rvTodoListDay4.setAdapter(todoListDay4Adapter);
        binding.rvTodoListDay4.setLayoutManager(new LinearLayoutManager(view.getContext()));

        binding.btnAddTaskDay4.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        taskViewModel.getDay4Tasks().observe(this, new Observer<List<Task>>() {
            @Override
            public void onChanged(List<Task> tasks) {
                ...
                todoListDay4Adapter.setTaskList(tasks);
            }
        });
    }
            ...
            btnNewTaskSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!TextUtils.isEmpty(etEnterTaskTitle.getText()) && !TextUtils.isEmpty(etEnterTime.getText())) {
                        taskViewModel.insertTask(new Task(etEnterTaskTitle.getText().toString(), etEnterTime.getText().toString(),3));
