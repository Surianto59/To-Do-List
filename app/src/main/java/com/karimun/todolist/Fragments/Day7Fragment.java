...
import com.karimun.todolist.Adapters.TodoListDay7Adapter;
...
public class Day7Fragment extends Fragment {
    //private static final String TAG = Day7Fragment.class.getSimpleName();

    com.karimun.todolist.databinding.FragmentDay7Binding binding;
    TodoListDay7Adapter todoListDay7Adapter;
    TaskViewModel taskViewModel;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = com.karimun.todolist.databinding.FragmentDay7Binding.inflate(inflater);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        todoListDay7Adapter = new TodoListDay7Adapter();
        taskViewModel = ViewModelProviders.of(this).get(TaskViewModel.class);

        binding.rvTodoListDay7.setAdapter(todoListDay7Adapter);
        binding.rvTodoListDay7.setLayoutManager(new LinearLayoutManager(view.getContext()));

        binding.btnAddTaskDay7.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        taskViewModel.getDay7Tasks().observe(this, new Observer<List<Task>>() {
            @Override
            public void onChanged(List<Task> tasks) {
                ...
                todoListDay7Adapter.setTaskList(tasks);
            }
        });
    }
            ...
            btnNewTaskSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!TextUtils.isEmpty(etEnterTaskTitle.getText()) && !TextUtils.isEmpty(etEnterTime.getText())) {
                        taskViewModel.insertTask(new Task(etEnterTaskTitle.getText().toString(), etEnterTime.getText().toString(), 6));
