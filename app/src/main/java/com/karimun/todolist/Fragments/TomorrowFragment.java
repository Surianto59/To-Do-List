...
import com.karimun.todolist.Adapters.TodoListTomorrowAdapter;
...
public class TomorrowFragment extends Fragment {
    //private static final String TAG = TomorrowFragment.class.getSimpleName();

    FragmentTomorrowBinding binding;
    TodoListTomorrowAdapter todoListTomorrowAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        todoListTomorrowAdapter = new TodoListTomorrowAdapter();
        taskViewModel = ViewModelProviders.of(this).get(TaskViewModel.class);

        binding.rvTodoListTomorrow.setAdapter(todoListTomorrowAdapter);
        binding.rvTodoListTomorrow.setLayoutManager(new LinearLayoutManager(view.getContext()));

        binding.btnAddTaskTomorrow.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        taskViewModel.getTomorrowTasks().observe(this, new Observer<List<Task>>() {
            @Override
            public void onChanged(List<Task> tasks) {
                ...
                todoListTomorrowAdapter.setTaskList(tasks);
            }
        });
    }
            ...
            btnNewTaskSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!TextUtils.isEmpty(etEnterTaskTitle.getText()) && !TextUtils.isEmpty(etEnterTime.getText())) {
                        taskViewModel.insertTask(new Task(etEnterTaskTitle.getText().toString(), etEnterTime.getText().toString(), 1));
